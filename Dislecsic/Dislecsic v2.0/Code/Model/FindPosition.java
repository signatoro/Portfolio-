...
public class FindPosition
{
    public static double[][] forest = 
        { 
            ...
            {.00, .00, .15, .12, .42, .00, .41, .12, .14, .00, .00, .00, .00, .00, .00, .11, .00, .00, .00, .00, .00, .11, .00, .00, .00, .00, .00, .20, .52, .19, .00, .00, .00, .00},
    ...
    public static double [][] cave = 
    {
        ...
        {.00, .44, .12, .10, .56, .10, .10, .46, .12, .12, .12, .10, .53, .63, .54, .10, .12, .12, .12, .16, .00, .00, .00, .00, .00, .00, .10, .54, .10, .12, .12, .10, .36, .10, .12, .43, .00},
    ...
    public void MoveResponce(int x, int y)
    {
        ...
        if (!(GameLoop.cave))
        {
            if (tile == .00)
            {
                Global.view.printText("Their is a whall there with an inspirasional kat poster on it.");
            }
            else if (tile == .10) 
            {
                Global.view.printText("Yoo are in a room.");
            } 
            else if (tile == .11)
            {
                Global.view.printText("They're are walls to you're east and west.");
            }
            else if (tile == .12) 
            {
                Global.view.printText("There are whals to your north and south");
            } 
            else if (tile == .13) 
            {
                Global.view.printText("Their are walls north and west of yoo.");
            } 
            else if (tile == .14) 
            {
                Global.view.printText("There are whalls north and east of yoe.");
            }
            else if (tile == .15) 
            {
                Global.view.printText("They're are wals south and west of you.");
            } 
            else if (tile == .16) 
            {
                Global.view.printText("Their are walls too your south and east.");
            }
            else if (tile == .17) 
            {
                Global.view.printText("There is a wall two the south of yoe.");
            } 
            else if (tile == .18) 
            {
                Global.view.printText("Their is a wall to your north.");
            } 
            else if (tile == .19) 
            {
                Global.view.printText("They're is a wall to your east");
            }
            else if (tile == .20) 
            {
                Global.view.printText("There is a wall too your west.");
            }
            else if (tile == .21) {
                Global.view.printText("Yoe are at an Intersecsion.");
            }
        }
        else if (GameLoop.cave)
        {
            ...
            {
                Global.view.printText("Their are walls west and east of yoe.");
            }
            else if (tile == .12) 
            {
                Global.view.printText("They're are walls north and south of you.");
            } 
            else if (tile == .13) 
            {
                Global.view.printText("There are whalls north and west of yoo.");
            } 
            else if (tile == .14) 
            {
                Global.view.printText("Their are wals north and east of yoe.");
            }
            else if (tile == .15) 
            {
                Global.view.printText("There ar whals south and west of you.");
            } 
            else if (tile == .16) 
            {
                Global.view.printText("Their walls south and east of yoe.");
            }
            else if (tile == .17) 
            {
                Global.view.printText("They're is a whall south of you.");
            } 
            else if (tile == .18) 
            {
                Global.view.printText("Their is a whall north of you.");
            } 
            else if (tile == .19) 
            {
                Global.view.printText("There is a whall east of yoe");
            }
            else if (tile == .20) 
            {
                Global.view.printText("They're is a wal west of you.");
            }
        }
    }
