...
public class GuiView extends JFrame implements KeyListener{
    ...
    public void creditScreen() {
        ...
        creditText.setText(creditText.getText() + "Story writen by Scott Pignataro\n");
    ...
    public void instructionScreen() {
        ...
        //text.setFont(new Font("Rockwell Extra Bold", Font.PLAIN, 12));
        // Move
        ...
        //text.setFont(new Font("Rockwell Extra Bold", Font.BOLD, 19));
    ...
    public void userInputHelper(KeyEvent e) {
        ...
        StringBuffer text = new StringBuffer(currentInputLabel.getText());
